...
// Since all the tests use the time to determine filenames etc, we need to
// control the wall clock as much as possible, which means having a wall clock
// that doesn't change unless we want it to. Access is synchronized because
// millRunOnce reads the time from a background goroutine.
var (
...
func TestLogger(t *testing.T) {
	...
	t.Run("open_existing", func(t *testing.T) {
	...
	t.Run("write_too_long", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("make_log_dir", func(t *testing.T) {
	...
	t.Run("default_filename", func(t *testing.T) {
		dir := os.TempDir()
	...
	t.Run("auto_rotate", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("first_write_rotate", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("max_backups", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("cleanup_existing_backups", func(t *testing.T) {
	...
	t.Run("old_log_files", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("time_from_name", func(t *testing.T) {
	...
	t.Run("compress_on_rotate", func(t *testing.T) {
		megabyte = 1
	...
	t.Run("compress_on_resume", func(t *testing.T) {
		megabyte = 1
